...
| ------ | ----------- | ----- | -------- | --- |
| 16 | 16-20250720 | 13.0.0 | 2.44 | 16.3 |
...
For better performance, there are “64”-bit “x86-64-v2” (sse4.2, 2008) variants: 64-v2-mcf, 64-v2-win32, 64-v2-ucrt, 64-v2-msvcrt. In addition, they are built with `-O2` instead of `-Os`, and have LTO enabled for GCC and Binutils. There is currently no plan for “x86-64-v3” (avx2, 2013) or later (not supported by upstream because of stack alignment).
