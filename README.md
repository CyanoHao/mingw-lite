...
- Native toolchain: the toolchain is static by default.
  - Profiles that target Windows 2000 (NT 5.0, see below) or later provide optional shared runtime libraries.
...
| ------ | ----------- | ----- | -------- | --- |
| 16 | 16-20251130 | 13.0.0 | 2.45 | 16.3 |
...
| Profile | Branch 16, 15 | Branch 14, 13 |
| ----------- | ------------- | ------------- |
| *-mcf | NT 6.1 (7) | NT 6.1 (7) |
| *-win32 | NT 6.0 (Vista) | NT 6.0 (Vista) |
| {64,64_v2}-{ucrt,msvcrt} | NT 5.2 (Server 2003) | NT 5.2 (Server 2003) |
| 32-ucrt | NT 5.1 (XP) | NT 5.1 (XP) |
| 32-msvcrt | NT 5.0 (2000) | NT 5.1 (XP) |

Some profiles have variants for even earlier Windows versions (and possibly older CPUs), as follows.

| Profile variant | Branch 16, 15 | Branch 14, 13 |
| --------------- | ------------- | ------------- |
