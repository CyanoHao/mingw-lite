...
PROFILES: Dict[str, ProfileInfo] = {
  ...
  '32-msvcrt_win2000': _create_profile('32', 'msvcrt', 'posix', '5.0', False),
...
def _profile_32_msvcrt(branch: str):
  v = Version(branch)
  if v.major >= 15:
    return _create_profile('32', 'msvcrt', 'posix', '5.0')
  else:
    return _create_profile('32', 'msvcrt', 'posix', '5.1')

BRANCH_DEPENDENT_PROFILES: Dict[str, Callable[[str], ProfileInfo]] = {
  '32-msvcrt': _profile_32_msvcrt,
}
