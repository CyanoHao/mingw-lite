...
// MinGW-lite: use GCC section attributes instead of #pragma section + __declspec(allocate).
extern "C" alignas(sizeof(__asan_global))
    __attribute__((section(".ASAN$GA"))) __asan_global __asan_globals_start = {};
extern "C" alignas(sizeof(__asan_global))
    __attribute__((section(".ASAN$GZ"))) __asan_global __asan_globals_end = {};
...
// Register globals
extern "C" __attribute__((section(".CRT$XCU")))
void (*const __asan_dso_reg_hook)() = &register_dso_globals;
extern "C" __attribute__((section(".CRT$XTX")))
