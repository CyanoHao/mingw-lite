...
static thread_local void *fake_tsd = 0;
...
// MinGW-lite: GCC section attributes replace #pragma section + __declspec(allocate).
__attribute__((section(".CRT$XCAB"))) int (*__intercept_seh)() =
...
__attribute__((section(".CRT$XLAB"))) void(NTAPI *__asan_tls_init)(
...
__attribute__((section(".CRT$XLY"))) void(NTAPI *__asan_tls_exit)(
